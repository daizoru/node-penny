...
(function() {
  ...
  Amount = (function() {
    ...
    function Amount(value, currency, oldValue) {
      ...
      if (this.value.currency != null) {
        this.value = this.value.value;
        this.currency = this.value.currency;
      }
      if (this.oldValue.currency != null) {
        this.oldValue = this.oldValue.value;
      }
    ...
    Amount.prototype.add = function(amount) {
      if (amount.currency != null) {
        amount = amount.to(this.currency.code);
      }
      return new Amount(this.value + amount, this.currency, this.value);
    };
    ...
    Amount.prototype.set = function(amount) {
      ...
      return new Amount(amount, this.currency, this.value);
    };
